...
public final class DependencyGraphBuilder implements Cancelable {
   ...
   */
  private static final boolean NO_BACKGROUND_THREADS = true; // System.getProperty("DependencyGraphBuilder.noBackgroundThreads", "FALSE").equalsIgnoreCase("TRUE"); TODO CHANGE BACK
   ...
   */
  private static final boolean DEBUG_DUMP_DEPENDENCY_GRAPH = true; //System.getProperty("DependencyGraphBuilder.dumpDependencyGraph", "FALSE").equalsIgnoreCase("TRUE"); TODO CHANGE BACK
  ...
  protected final class Job implements Runnable, Cancelable {
    ...
    public void run() {
      ...
      // Repeat for as longs as there are jobs left to run and not poisoned
      do {
